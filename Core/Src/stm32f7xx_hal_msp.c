...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    GPIO_InitStruct.Pin = BATMON_IO1_Pin|BATMON_IO2_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOA, BATMON_IO1_Pin|BATMON_IO2_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM8)
  {
    ...
    PI5     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = PWM_CH6_Pin|PWM_CH7_Pin|PWM_CH8_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = PWM_CH5_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(PWM_CH5_GPIO_Port, &GPIO_InitStruct);
