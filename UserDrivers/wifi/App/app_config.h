...
#define LOG_OUTPUT_MODE             LOG_OUTPUT_PRINTF

/* WiFi Credential Configuration Mode */
// Uncomment to use credentials from NVRAM (UserConfig system)
// If undefined, falls back to hardcoded credentials below
#define USE_NVRAM_WIFI_CREDENTIALS

/* Local Access Point (e.g. gateway, hotspot, etc) connection parameters */
// These are fallback credentials used when:
// 1. USE_NVRAM_WIFI_CREDENTIALS is undefined, OR
// 2. No valid credentials are stored in NVRAM
