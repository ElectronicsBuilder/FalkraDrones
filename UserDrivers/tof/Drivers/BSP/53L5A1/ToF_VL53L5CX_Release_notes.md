...
<label for="collapse-section1" aria-hidden="true">__1.0.2 / March 4th 2022__</label>
<div>			
...
## Contents
  ...
  ----------------------------------------------------------- ------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------
  **VL53L5CX BSP Component**                                                V1.0.2[]{.icon-st-update}           [release note URL](.\Release_Notes.html)
  **VL53L5 ULD**                                                            V1.2.0[]{.icon-st-update}           [release note URL](.\Release_Notes.html)
...
## Contents
  ...
  Name                                                        Version                                           Release note
  ----------------------------------------------------------- ------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------
  **VL53L5CX BSP Component**                                                V1.0.1[]{.icon-st-update}           [release note URL](.\Release_Notes.html)
  **VL53L5 ULD**                                                            V1.2.0[]{.icon-st-update}           [release note URL](.\Release_Notes.html)
...
This is the first release of the **VL53L5CX** Component Driver. 

## Contents

  Name                                                        Version                                           License                                                                                                       Release note
  ----------------------------------------------------------- ------------------------------------------------- ------------------------------------------------------------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------
  **VL53L5CX BSP Component**                                                V1.0.0[]{.icon-st-add}                                   [BSD 3-Clause](https://opensource.org/licenses/BSD-3-Clause)                                                [release note URL](.\Release_Notes.html)
  **VL53L5 ULD**                                                            V1.0.0[]{.icon-st-add}                        [SLA0081](http://www.st.com/SLA0081) or [BSD 3-Clause](https://opensource.org/licenses/BSD-3-Clause)                                                                                          [release note URL](.\Release_Notes.html)
