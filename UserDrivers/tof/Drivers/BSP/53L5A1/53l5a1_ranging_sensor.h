...
#define VL53L5A1_DEV_RIGHT      (5U) /*!< left satellite device */
#define VL53L5A1_DEV_LEFT       (4U) /*!< left satellite device */
#define VL53L5A1_DEV_BACK       (3U) /*!< left satellite device */
#define VL53L5A1_DEV_FRONT      (2U) /*!< left satellite device */
#define VL53L5A1_DEV_BOTTOM     (1U) /*!< center (built-in) device */
#define VL53L5A1_DEV_TOP        (0U) /*!< right satellite device */
/**
  * @}
  */
...
int32_t vl53l5cx_i2c_recover3(void);
/**
  * @}
  */
