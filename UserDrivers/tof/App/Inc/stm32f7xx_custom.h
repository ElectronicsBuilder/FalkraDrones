...
#ifndef __STM32F7XX_CUSTOM_H
#define __STM32F7XX_CUSTOM_H
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f7xx_custom_conf.h"
#include "stm32f7xx_custom_errno.h"
#include "main.h"
...
/** @defgroup STM32F7xx_custom_LOW_LEVEL
 * @{
 */

/** @defgroup STM32L7xx_custom_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  * @{
  */
/**
 * @brief STM32F4XX NUCLEO BSP Driver version number V1.0.0
 */
#define __STM32F7xx_custom_BSP_VERSION_MAIN   (uint32_t)(0x01) /*!< [31:24] main version */
#define __STM32F7xx_custom_BSP_VERSION_SUB1   (uint32_t)(0x00) /*!< [23:16] sub1 version */
#define __STM32F7xx_custom_BSP_VERSION_SUB2   (uint32_t)(0x00) /*!< [15:8]  sub2 version */
#define __STM32F7xx_custom_BSP_VERSION_RC     (uint32_t)(0x00) /*!< [7:0]  release candidate */
#define __STM32F7xx_custom_BSP_VERSION        ((__STM32F7xx_custom_BSP_VERSION_MAIN << 24)\
                                                    |(__STM32F7xx_custom_BSP_VERSION_SUB1 << 16)\
                                                    |(__STM32F7xx_custom_BSP_VERSION_SUB2 << 8 )\
                                                    |(__STM32F7xx_custom_BSP_VERSION_RC))

/** @defgroup STM32F7xx_custom_LOW_LEVEL_Exported_Types STM32F4XX_NUCLEO LOW LEVEL Exported Types
 * @{
 */
...
/** @defgroup STM32F7xx_custom_LOW_LEVEL_COM STM32F4XX_NUCLEO LOW LEVEL COM
 * @{
 */
/**
...
/** @defgroup STM32F7xx_custom_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
#ifndef USE_BSP_COM
...
/** @defgroup STM32F7xx_custom_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
/**
  * @}
...
/** @defgroup STM32F7xx_custom_LOW_LEVEL_Exported_Functions STM32F4XX_NUCLEO LOW LEVEL Exported Functions
 * @{
 */
